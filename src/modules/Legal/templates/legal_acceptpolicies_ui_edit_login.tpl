...
<fieldset>
    ...
    {if $activePolicies.privacyPolicy && !$originalAcceptedPolicies.privacyPolicy}
        ...
        <div class="z-formrow">
            ...
            <span class="z-formlist">
                <input type="checkbox" id="acceptpolicies_privacypolicy" name="acceptedpolicies_privacypolicy" {if isset($fieldErrors.agePolicy) && !empty($fieldErrors.privacyPolicy)}class="z-form-error"{/if} {if $acceptedPolicies.privacyPolicy}checked="checked"{/if} value="1" />
    ...
    {if $activePolicies.agePolicy && !$originalAcceptedPolicies.agePolicy}
        ...
        <div class="z-formrow">
            ...
            <span class="z-formlist">
                <input type="checkbox" id="acceptpolicies_agepolicy" name="acceptedpolicies_agepolicy" {if isset($fieldErrors.privacyPolicy) && !empty($fieldErrors.agePolicy)}class="z-form-error"{/if} {if $acceptedPolicies.agePolicy}checked="checked"{/if} value="1" />
